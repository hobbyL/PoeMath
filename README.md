...
**韵算 (PoeMath)** 是一款完全离线的 Flutter 应用，专为小学 1-6 年级学生设计，将**古诗词背诵**与**口算训练**融合在一个轻量、无广告、零隐私风险的学习工具中。
...
- 🎉 **感官反馈**：答对 confetti 粒子特效、Lottie 庆祝弹窗、音效、触觉反馈
- 💾 **数据备份/恢复**：一键导出全部学习数据为 JSON，跨设备恢复
...
韵算严格保护用户隐私，详见 [隐私政策](docs/PRIVACY.md)。
